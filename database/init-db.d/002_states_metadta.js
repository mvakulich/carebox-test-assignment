const data = [
  ...
  },
  {
    ...
    covid19SiteQuinary: "https://covid19.colorado.gov/data",
    twitter: "@cdphe",
    covid19SiteOld:
  ...
  },
  {
    ...
    covid19Site:
      "https://myhealthycommunity.dhss.delaware.gov/locations/state#testing",
    covid19SiteSecondary:
      "https://myhealthycommunity.dhss.delaware.gov/locations/state#testing",
    covid19SiteTertiary: null,
    covid19SiteQuaternary: null,
  ...
  },
  {
    ...
    covid19SiteQuaternary:
      "https://coronavirus.iowa.gov/pages/serology-testing",
    covid19SiteQuinary: null,
  ...
  },
  {
    state: "IN",
    notes:
      "Indiana combines PCR and antigen tests in the total tests figure reported on the state's dashboard.\n\nNegative test results reported in our API and CSVs are calculated by subtracting **Total cases** from **Total PCR tests (people)** in the absence of better data.\n\nOn March 6, 2021, Indiana announced that a new testing facility had been added to their electronic reporting system, resulting in 1241 Total PCR tests (people), 3769 Total PCR tests (specimens), and 445 Cases (confirmed in probable) reported on March 6, 2021. Additionally, their Ever in ICU decreased by 2 without explanation.\n\nOn February 26, 2021, Indiana announced that due to a historic load of negative tests, 663 older Total PCR tests (people) and 2150 Total PCR tests (specimens) would be included in their data for the day.\n\nOn February 4, 2021, Indiana announced that their deaths included “1,507 historical deaths identified through an audit of 2020 and 2021 COVID death records and test results”. As a result, the majority of new Deaths (confirmed + probable) and Deaths (confirmed) reported on February 4, 2021 were not reported in the previous 24 hours. We urge caution when looking at this figure.\n\nOn January 5, 2021, Indiana’s Currently in ICU decreased by 9 without explanation.\n\nOn November 29, 2020, Indiana announced that a historical backlog of roughly 2200 Total PCR tests (people) and about 4000 Total PCR tests (specimens) would be included in their data for November 29, 2020. The `Negative` field in the API will also be affected. As a result, new tests reported on November 29, 2020 were not all reported in the previous 24 hour period.\n\nAs of October 16, 2020, Indiana’s total test results are drawn from our totalTestsViral field instead of calculated via positive+negative.",
    covid19Site: "https://www.in.gov/isdh/28470.htm",
    covid19SiteSecondary: "https://www.regenstrief.org/covid-dashboard/",
    covid19SiteTertiary:
      "https://hub.mph.in.gov/dataset/covid-19-beds-and-vents/resource/882a7426-886f-48cc-bbe0-a8d14e3012e4/view/05961851-c7ab-4ac7-92bf-fdf9881ecdab",
    covid19SiteQuaternary:
      "https://hub.mph.in.gov/api/3/action/datastore_search_sql?sql=SELECT+sum%28%22COVID_POSITIVE_TESTS_ADMIN%22%29+as+pos_tests+from+%22afaa225d-ac4e-4e80-9190-f6800c366b58%22",
    covid19SiteQuinary: null,
  ...
  },
  {
    ...
    covid19SiteSecondary:
      "https://services.arcgis.com/njFNhDsUCentVYJW/arcgis/rest/services/MDCOVID19_TestingVolume/FeatureServer/0/query?where=1%3D1&outFields=*&outStatistics=[%7B%22statisticType%22%3A+%22sum%22%2C+%22onStatisticField%22%3A+%22number_of_positives%22%2C+%22outStatisticFieldName%22%3A+%22total_number_of_positives%22%7D]",
    covid19SiteTertiary:
      "https://services.arcgis.com/njFNhDsUCentVYJW/arcgis/rest/services/MDCOVID19_SerologyTests/FeatureServer/0/query?where=1%3D1&outFields=%2A",
    covid19SiteQuaternary: null,
    covid19SiteQuinary: null,
  ...
  },
  {
    ...
    covid19SiteQuaternary:
      "https://app.powerbigov.us/view?r=eyJrIjoiNDY0ZGVlMDItMzUzNC00ZGE5LWFjYzQtNzliOGJkZWQ4YTgzIiwidCI6ImQ1ZmI3MDg3LTM3NzctNDJhZC05NjZhLTg5MmVmNDcyMjVkMSJ9",
    covid19SiteQuinary: null,
    twitter: "@MichiganHHS",
  ...
  },
  {
    ...
    covid19SiteTertiary:
      "https://dphhs.mt.gov/Portals/85/publichealth/documents/CDEpi/DiseasesAtoZ/2019-nCoV/Status%20Update%20Data%20Report_5312021.pdf",
    covid19SiteQuaternary: null,
    covid19SiteQuinary: null,
    twitter: "@dphhsmt",
    covid19SiteOld:
  ...
  },
  {
    ...
    covid19SiteSecondary:
      "https://app.powerbigov.us/view?r=eyJrIjoiMjA2ZThiOWUtM2FlNS00MGY5LWFmYjUtNmQwNTQ3Nzg5N2I2IiwidCI6ImU0YTM0MGU2LWI4OWUtNGU2OC04ZWFhLTE1NDRkMjcwMzk4MCJ9&pageName=ReportSection713122d051caa3096e41",
    covid19SiteTertiary:
  ...
  },
  {
    ...
    covid19SiteQuaternary:
      "https://services5.arcgis.com/klquQoHA0q9zjblu/ArcGIS/rest/services/Datos_Totales_View7/FeatureServer/0/query?where=1%3D1&outFields=T_Muertes_COVID_RD%2CT_Muertes_Combinadas%2CT_Pacientes_Int_Covid%2CT_Vent_Covid%2CT_Serologicos_Pos%2CT_Casos_Unicos%2CT_Molecular_Pos%2CT_Fatalidades%2CT_Hospitalizados",
    covid19SiteQuinary: null,
    twitter: "@desaludpr",
  ...
  },
  {
    ...
    covid19SiteTertiary:
      "https://data.tn.gov/t/Public/views/HospitalizedPatients/HospitalizedPatients?:embed=y",
    covid19SiteQuaternary: null,
    covid19SiteQuinary: null,
  ...
  },
  {
    ...
    covid19SiteTertiary:
      "https://data.virginia.gov/resource/3u5k-c2gr.json?%24query=select+sum%28number_of_pcr_testing%29+as+pcr_testing%2C+sum%28number_of_positive_pcr_testing%29+as+pos_pcr_testing",
    covid19SiteQuaternary: null,
    covid19SiteQuinary: null,
    twitter: "@vdhgov",
    covid19SiteOld:
  ...
  },
  {
    state: "VI",
    notes:
      "Total PCR tests in the Virgin Islands is the sum of **Positive PCR tests**, **Negative PCR tests**, and **Pending tests**.\n\nThe Virgin Islands provides irregular data updates, so changes in values often represent multiple days of data.",
...
db.createCollection('state_metadata');

db.state_metadata.insertMany(data);